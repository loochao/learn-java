...
public class ChatServer extends JFrame implements ActionListener
{
	...
	JMenuBar jMenuBar = new JMenuBar();                    //建立菜单栏

	JMenu serviceMenu = new JMenu ("服务(V)");              //建立"服务(V)"菜单
	...
	//建立工具栏中的按钮组件
	JButton portSet;                                        //端口设置按钮
	JButton startServer;                                    //启动服务端侦听 启动服务按钮
	JButton stopServer;                                     //关闭服务端侦听 停止服务按钮
	...
	public void init()
	{
		...
		setJMenuBar (jMenuBar);              //this.setJMenuBar 将jMenuBar设置为窗口的菜单条
